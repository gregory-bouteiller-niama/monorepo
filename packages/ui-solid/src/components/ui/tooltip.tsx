...
type TooltipTriggerProps<T extends ValidComponent = "button"> = PolymorphicProps<T, TooltipPrimitive.TooltipTriggerProps<T>>;

const TooltipTrigger = <T extends ValidComponent = "button">(props: TooltipTriggerProps<T>) => (
  <TooltipPrimitive.Trigger data-slot="tooltip-trigger" {...props} />
);

type TooltipContentProps<T extends ValidComponent = "div"> = PolymorphicProps<T, TooltipPrimitive.TooltipContentProps<T>> &
