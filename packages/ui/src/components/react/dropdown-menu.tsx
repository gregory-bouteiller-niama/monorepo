...
const STYLES = tv({
	slots: {
		checkboxItem: `relative flex cursor-default select-none items-center gap-2.5 rounded-xl py-2 pr-8 pl-3 text-sm outline-hidden 
    ...
    [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0`,
		checkboxItemIndicator: "pointer-events-none absolute right-2 flex items-center justify-center",
		content: `data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 
    ...
    data-closed:overflow-hidden`,
		item: `group/dropdown-menu-item relative flex cursor-default select-none items-center gap-2.5 rounded-xl px-3 py-2 text-sm 
    ...
    [&_svg]:shrink-0 data-[variant=destructive]:*:[svg]:text-destructive`,
		label: "px-3 py-2.5 text-muted-foreground text-xs data-inset:pl-9.5",
		radioItem: `relative flex cursor-default select-none items-center gap-2.5 rounded-xl py-2 pr-8 pl-3 text-sm outline-hidden 
    ...
    data-inset:pl-9.5 data-disabled:opacity-50 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0`,
		...
		shortcut: "ml-auto text-muted-foreground text-xs tracking-widest group-focus/dropdown-menu-item:text-accent-foreground",
		subContent: `data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 
    data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 
    ...
    ring-1 ring-foreground/5 duration-100 data-closed:animate-out data-open:animate-in`,
		subTrigger: `flex cursor-default select-none items-center gap-2 rounded-xl px-3 py-2 text-sm outline-hidden focus:bg-accent 
    ...
    [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0`,
		subTriggerIcon: "icon-[tabler--chevron-right] ml-auto",
	},
});
export const DROPDOWN_MENU = STYLES();
...
export function DropdownMenuCheckboxItem({ className, children, checked, inset, ...props }: DropdownMenuCheckboxItemProps) {
	return (
		<MenuPrimitive.CheckboxItem
			checked={checked}
			className={DROPDOWN_MENU.checkboxItem({ className })}
			data-inset={inset}
...
export function DropdownMenuContent(props: DropdownMenuContentProps) {
	...
	return (
		<MenuPrimitive.Portal>
			...
			>
				<MenuPrimitive.Popup className={DROPDOWN_MENU.content({ className })} data-slot="dropdown-menu-content" {...rest} />
			</MenuPrimitive.Positioner>
		</MenuPrimitive.Portal>
	);
}
...
export function DropdownMenuItem({ className, inset, variant = "default", ...props }: DropdownMenuItemProps) {
	return (
		<MenuPrimitive.Item
			className={DROPDOWN_MENU.item({ className })}
			data-inset={inset}
...
export function DropdownMenuLabel({ className, inset, ...props }: DropdownMenuLabelProps) {
	return (
		<MenuPrimitive.GroupLabel
			className={DROPDOWN_MENU.label({ className })}
			data-inset={inset}
...
export function DropdownMenuRadioItem({ className, children, inset, ...props }: DropdownMenuRadioItemProps) {
	return (
		<MenuPrimitive.RadioItem
			className={DROPDOWN_MENU.radioItem({ className })}
			data-inset={inset}
...
export function DropdownMenuSeparator({ className, ...props }: DropdownMenuSeparatorProps) {
	return <MenuPrimitive.Separator className={DROPDOWN_MENU.separator({ className })} data-slot="dropdown-menu-separator" {...props} />;
}
export type DropdownMenuSeparatorProps = Omit<MenuPrimitive.Separator.Props, "className"> & { className?: string };

// SHORTCUT --------------------------------------------------------------------------------------------------------------------------------
export function DropdownMenuShortcut({ className, ...props }: DropdownMenuShortcutProps) {
	return <span className={DROPDOWN_MENU.shortcut({ className })} data-slot="dropdown-menu-shortcut" {...props} />;
}
...
export function DropdownMenuSubContent(props: DropdownMenuSubContentProps) {
	...
	return (
		<DropdownMenuContent
			align={align}
			alignOffset={alignOffset}
			className={DROPDOWN_MENU.subContent({ className })}
...
export function DropdownMenuSubTrigger({ className, inset, children, ...props }: DropdownMenuSubTriggerProps) {
	return (
		<MenuPrimitive.SubmenuTrigger
			className={DROPDOWN_MENU.subTrigger({ className })}
			data-inset={inset}
