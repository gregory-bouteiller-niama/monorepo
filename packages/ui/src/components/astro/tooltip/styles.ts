...
export const TOOLTIP = {
  ...
  content: cva(`starwind-tooltip-content group fixed z-50 hidden w-fit px-3 py-1.5 text-sm rounded-md bg-foreground text-background
    fade-in zoom-in-95 animate-in fade-out zoom-out-95 
    data-[state=closed]:animate-out data-[state=closed]:fill-mode-forwards
    data-[side=bottom]:slide-in-from-top-2 data-[side=top]:slide-in-from-bottom-2
    data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2`),
  caret: cva(`absolute z-50 size-4 text-foreground
  ...
  caretIcon: cva("icon-[tabler--caret-up-filled]"),
} as const;
