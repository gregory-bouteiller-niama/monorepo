import { SKY } from "@niama/ui/styles/sky";
...
export function Sky({
	...
	return (
		<div className={SKY.base({ className })}>
			<div className={SKY.orbits()}>
				<div className={SKY.orbit({ className: "animation-duration-[60s] size-1/3" })}>
					<div className={SKY.planet({ className: "bg-yogart shadow-[0_0_10px_2px_var(--yogart)] dark:bg-white" })} />
				</div>
				<div className={SKY.orbit({ className: "animation-duration-[120s] direction-[reverse] size-2/3" })}>
					<div className={SKY.planet({ className: "bg-anima shadow-[0_0_10px_2px_var(--anima)] dark:bg-white" })} />
				</div>
				<div className={SKY.orbit({ className: "animation-duration-[180s] size-11/12" })}>
					<div className={SKY.planet({ className: "bg-animus shadow-[0_0_10px_2px_var(--animus)] dark:bg-white" })} />
				</div>
			</div>
			<div
				className={SKY.stars()}
