...
const BADGE = cva(
  `group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden whitespace-nowrap rounded-4xl border 
...
export function Badge(props: BadgeProps) {
  ...
  return <span class={cn(BADGE({ variant }), className)} data-slot="badge" {...rest} />;
}
